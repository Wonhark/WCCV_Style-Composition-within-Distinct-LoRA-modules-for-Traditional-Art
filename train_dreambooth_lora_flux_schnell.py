...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="For folk_painting, specific class.",
    )
    parser.add_argument(
...
if __name__ == "__main__":
    ...
    # # args.instance_data_dir = "/data/"
    # args.instance_data_dir = f'/data/trad_art_25/1.Baekmyo_Yunpil/source'
    # # args.class_data_dir = f'/data/wonhark/MultiCustom/prior_preservation_data/sd3/man_various_prompts/image'
    # # args.num_class_images = 100
    # args.output_dir = "/data/trad_art_25/flux/outputs/1.Baekmyo_Yunpil/"
    # args.instance_prompt = 'photo in sks style'
    #
    ...
    # args.rank = 16
    #
    # args.validation_epochs = 500

    if args.object_class is not None:
        args.validation_prompt = [
            f'zzv style {args.object_class}',
            f'zzv style {args.object_class} in the mountain',
            f'zzv style {args.object_class} in traditional Korean style image',
        ]
    else:
        args.validation_prompt = [
            'zzv style image',
            'dog in zzv style',
            'natural landscape in zzv style',
        ]
